...
outputs/X_train_count.pickle outputs/X_test_count.pickle outputs/X_train_feature_names: count_vector.py outputs/x_train.npy outputs/x_test.npy outputs/test_data.npy
