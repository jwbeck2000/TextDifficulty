...
if __name__ == '__main__':
	...
	parser.add_argument('output_file_1', help='TfidfVector for the training data (pkl)')
	parser.add_argument('output_file_2', help='TfidfVector for the testing data (pkl)')
	parser.add_argument('output_file_3', help='TfidfVector for the actual testing data (pkl)')
	args = parser.parse_args()

	X_train, X_test, A_test = tfidf_vector(args.input_file_1, args.input_file_2, args.input_file_3)
